    ...
    render ()
    {
        ...
        return (
            <div className="header-container">
                {/* thanh navigator */ }
                <div className="header-tabs-container d-flex" title="Trang chủ">
                    <div onClick={ () => this.Moveto( 'system/home-admin' ) }>
                ...
                <div className='language'>
                    <span className='welcom'><FormattedMessage id="homeheader.welcome" />, <b>{ userInfo && userInfo.lastName ? userInfo.lastName : "" } !</b></span>
